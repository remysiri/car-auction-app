        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('auctions.update', $auctions->id) }}">
                            @csrf
                            @method('PUT')

                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="title" placeholder="Title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $auctions->title }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <textarea id="description" placeholder="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" required autofocus>{{ $auctions->description }}</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="price" placeholder="0 000.00" type="number" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ $auctions->price }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="miles" placeholder="0 000.00" type="number" class="form-control{{ $errors->has('miles') ? ' is-invalid' : '' }}" name="miles" value="{{ $auctions->miles }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="kilometres" placeholder="0 000.00" type="number" class="form-control{{ $errors->has('kilometres') ? ' is-invalid' : '' }}" name="kilometres" value="{{ $auctions->kilometres }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="model" placeholder="Car model" type="text" class="form-control{{ $errors->has('model') ? ' is-invalid' : '' }}" name="model" value="{{ $auctions->model }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="chassis" placeholder="Chassis Prefix" type="text" class="form-control{{ $errors->has('chassis') ? ' is-invalid' : '' }}" name="chassis" value="{{ $auctions->chassis }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="manufacture" placeholder="Date of manufacture" type="number" class="form-control{{ $errors->has('manufacture') ? ' is-invalid' : '' }}" name="manufacture" value="{{ $auctions->manufacture }}" required autofocus>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <input id="color" placeholder="Color" type="text" class="form-control{{ $errors->has('color') ? ' is-invalid' : '' }}" name="color" value="{{ $auctions->color }}" required autofocus>
