...
class StatusController extends Controller
{
    ...
    {
        $statusues = Auctions::whereHas('status', function($q){$q->whereIn('name', ['pending']);})->get();
        $statuseees = Status::where('name', 'pending')->first()->auctions()->get();
        $statuses = Auctions::first()->status;
